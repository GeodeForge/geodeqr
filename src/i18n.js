(function (root) {
  ...
  var S = {
    en: { name: 'English',
      ...
      verifyBody: 'Open your browser’s developer tools, switch to the Network tab, and make a code. Nothing happens — no request leaves your device.',
      ...
      moreBody: 'GeodeForge finds tools that are hostile to use and/or don\'t deliver on their promises, works out why, and rebuilds them to be user-friendly. More coming!',
